...
This is a sample template for SwaggerSample - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name swaggersample --query 'Stacks[].Outputs'
```
